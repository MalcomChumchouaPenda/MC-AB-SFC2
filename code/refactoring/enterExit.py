...
class enterExit:
      def __init__(self,Lcountry,McountryFirmMaxNumber,\
                   ...
                   propTradable,Fcost,ni,minMarkUp,iotaE,theta,sigma):
      ...
      def enter(self,McountryConsumer,McountryFirm,time,McountryBank,McountryCentralBank,McountryAvPrice):
          enteringfirm=0
          enteringbank=0
                    ...
                    if sumInv>=newAgentSize:
                       if newAgentKind=='firmNotTradable' or newAgentKind=='firmTradable':
                          if newAgentKind=='firmNotTradable':
                             ...
                             newfirm=Firm(firmide,country,newfirmA,phi,\
                                    ...
                                    self.upsilon,self.gamma,self.deltaInnovation,\
                                    price,self.Fcost,\
                       ...
                       if newAgentKind=='bank': 
                          ...
                          newbank=Bank(bankide,country,newbankA,self.Lcountry,self.Fcost,self.folder,self.name,\
                                    ...
                                    self.dividendRate,self.iota,self.rDeposit,self.mu1,self.iotaE)
