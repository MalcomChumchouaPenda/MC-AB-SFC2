...
class enterExit:
    def __init__(
        self,
        Lcountry,
        McountryFirmMaxNumber,
        folder,
        name,
        run,
        delta,
        initialA,
        McountryBankMaxNumber,
        probBank,
        minReserve,
        rDiscount,
        xi,
    ...
    def minMaxAgents(self, McountryFirm, McountryBank, country, McountryAvPrice):
        ...
        for firm in McountryFirm[country]:
            ...
            if McountryFirm[country][firm].tradable == "no":
                ...
                LfirmPriceNotTradable.append(
                    McountryFirm[country][firm].price
                )  # Lselling[0])
                LfirmWageNotTradable.append(McountryFirm[country][firm].w)
                sumQNotTradable = (
                    sumQNotTradable + McountryFirm[country][firm].xSold
                )  # Lsold[2]
        ...
        if len(LfirmSizeNotTradable) > 0:
            ...
            self.medianFirmExNotTradable = LfirmExNotTradable[
                int(len(LfirmExNotTradable) / 2.0)
            ]
            self.medianFirmSizeNotTradable = LfirmSizeNotTradable[
                int(len(LfirmSizeNotTradable) / 2.0)
            ]
            self.minFirmPhiNotTradable = min(LfirmPhiNotTradable)
            self.maxFirmPhiNotTradable = max(LfirmPhiNotTradable)
            self.medianFirmPhiNotTradable = LfirmPhiNotTradable[
                int(len(LfirmPhiNotTradable) / 2.0)
            ]
            self.minFirmPriceNotTradable = min(LfirmPriceNotTradable)
            self.maxFirmPriceNotTradable = max(LfirmPriceNotTradable)
            self.medianFirmPriceNotTradable = LfirmPriceNotTradable[
                int(len(LfirmPriceNotTradable) / 2.0)
            ]
            self.minFirmWageNotTradable = min(LfirmWageNotTradable)
            self.maxFirmWageNotTradable = max(LfirmWageNotTradable)
            self.medianFirmWageNotTradable = LfirmWageNotTradable[
                int(len(LfirmWageNotTradable) / 2.0)
            ]
        if len(LfirmSizeNotTradable) == 0:
        ...
        for firm in McountryFirm[country]:
            if McountryFirm[country][firm].tradable == "yes":
                ...
                LfirmPriceTradable.append(
                    McountryFirm[country][firm].price
                )  # Lselling[0])
                LfirmWageTradable.append(McountryFirm[country][firm].w)
                sumQTradable = (
                    sumQTradable + McountryFirm[country][firm].xSold
                )  # Lsold[2]
        if len(LfirmSizeTradable) > 0:
            ...
            self.medianFirmSizeTradable = LfirmSizeTradable[
                int(len(LfirmSizeTradable) / 2.0)
            ]
            self.minFirmPhiTradable = min(LfirmPhiTradable)
            self.maxFirmPhiTradable = max(LfirmPhiTradable)
            self.medianFirmPhiTradable = LfirmPhiTradable[
                int(len(LfirmPhiTradable) / 2.0)
            ]
            self.minFirmPriceTradable = min(LfirmPriceTradable)
            self.maxFirmPriceTradable = max(LfirmPriceTradable)
            self.medianFirmPriceTradable = LfirmPriceTradable[
                int(len(LfirmPriceTradable) / 2.0)
            ]
            self.minFirmWageTradable = min(LfirmWageTradable)
            self.maxFirmWageTradable = max(LfirmWageTradable)
            self.medianFirmWageTradable = LfirmWageTradable[
                int(len(LfirmWageTradable) / 2.0)
            ]
        if len(LfirmSizeTradable) == 0:
    ...
    def whichSize(self, kind):
        if kind == "firmNotTradable":
            ...
            size = max(
                ...
                wage,
                random.uniform(
                    self.minFirmSizeNotTradable, self.maxFirmSizeNotTradable
                ),
            )
        ...
        if kind == "firmTradable":
            ...
            size = max(
                self.initialA,
                wage,
                random.uniform(self.minFirmSizeTradable, self.maxFirmSizeTradable),
            )
        ...
        if kind == "bank":
            ...
            sizeMin = max(
                self.sigma * self.medianFirmSizeNotTradable,
                4 * self.medianFirmSizeTradable,
                self.minBankSizePast,
            )
    ...
    def whichPrice(self, kind):
        if kind == "firmNotTradable":
            price = random.uniform(
                self.minFirmPriceNotTradable, self.maxFirmPriceNotTradable
            )
        if kind == "firmTradable":
    ...
    def whichWage(self, kind):
        if kind == "firmNotTradable":
            wage = random.uniform(
                self.minFirmWageNotTradable, self.maxFirmWageNotTradable
            )
        if kind == "firmTradable":
    ...
    def whichAgentEnter6(self, country, McountryFirm, McountryBank):
        ...
        if (
            ratioBankFirm < self.initialProbBank
            or rationBankFirmNumber < self.initialProbBank
        ):
            # if country==0:
            newAgent = "bank"
        if (
            ratioBankFirm >= self.initialProbBank
            and rationBankFirmNumber >= self.initialProbBank
        ):
    ...
    def enter(
        ...
        for country in McountryConsumer:
            ...
            for consumer in McountryConsumer[country]:
                if (
                    McountryConsumer[country][consumer].Investing
                    > McountryConsumer[country][consumer].wBar * avWage
                    and len(McountryConsumer[country][consumer].DLA) <= lenPartecipation
                ):
                    totalInvesting = (
                        totalInvesting + McountryConsumer[country][consumer].Investing
                    )
            ...
            while i < li:
                ...
                if sumInv >= newAgentSize:
                    if (
                        newAgentKind == "firmNotTradable"
                        or newAgentKind == "firmTradable"
                    ):
                        if newAgentKind == "firmNotTradable":
                            ...
                            self.DcountryEnterValue[country] = (
                        ...
                        while j < lj:
                            ...
                            LconsumerInvesting[j][2] = (
                                LconsumerInvesting[j][2] + consumerShare
                            )
                            pos = LconsumerInvesting[j][4]
                            McountryConsumer[country][consumeride].Investing = 0
                            McountryConsumer[country][consumeride].DLA[newfirm.ide] = [
                                consumeride,
                                newfirm.ide,
                                consumerShare,
                                pos,
                            ...
                            McountryConsumer[country][consumeride].paying(
                                consumerShare, McountryBank, McountryCentralBank
                            )
                            LconsumerAsset.append(
                                [consumeride, newfirm.ide, consumerShare]
                            )
                            newfirm.Downer[consumeride] = McountryConsumer[country][
                                consumeride
                            ].DLA[newfirm.ide]
                        ...
                        LconsumerInvesting[i][1] = (
                            LconsumerInvesting[i][1] - consumerShare
                        )
                        LconsumerInvesting[i][2] = (
                            LconsumerInvesting[i][2] + consumerShare
                        )
                        pos = LconsumerInvesting[i][4]
                        McountryConsumer[country][
                            consumeride
                        ].Investing = LconsumerInvesting[i][
                            1
                        ]  # 0
                        ratioA = consumerShare / float(newAgentSize)
                        McountryConsumer[country][consumeride].DLA[newfirm.ide] = [
                        ...
                        self.DcountryFirmEnter[country] = (
                    ...
                    if newAgentKind == "bank":
                        ...
                        while j < lj:
                            ...
                            McountryConsumer[country][consumeride].Investing = 0
                            ratioA = consumerShare / float(newAgentSize)
                            McountryConsumer[country][consumeride].DLA[newbank.ide] = [
                                consumeride,
                                newbank.ide,
                                consumerShare,
                                pos,
                            ...
                            LconsumerAsset.append(
                                [consumeride, newbank.ide, consumerShare]
                            )
                            newbank.Downer[consumeride] = McountryConsumer[country][
                                consumeride
                            ].DLA[newbank.ide]
                        ...
                        pos = LconsumerInvesting[i][4]
                        McountryConsumer[country][consumeride].Investing = (
                            LconsumerInvesting[i][1]
                        )
                        ratioA = consumerShare / float(newAgentSize)
                        McountryConsumer[country][consumeride].DLA[newbank.ide] = [
                        ...
                        McountryCentralBank[country].Reserves = (
                            McountryCentralBank[country].Reserves + newbank.Reserves
                        )
                        McountryBank[country][newbank.ide] = newbank
                        enteringbank = enteringbank + 1
                        self.DcountryBankEnter[country] = (
        ...
        for country in McountryFirm:
            ...
            for firm in LfirmExit:
                if McountryFirm[country][firm].loanReceived > 0.0:
                    rap = McountryFirm[country][firm].loanReimboursed / float(
                        McountryFirm[country][firm].loanReceived
                    )
                    diff = (
                        McountryFirm[country][firm].loanReimboursed
                        - McountryFirm[country][firm].loanReceived
                    )
                    ...
                    for bank in McountryFirm[country][firm].Mloan:
                        ...
                        if McountryBank[countryBank][ideBank].ide == ideBank:
                            reimbourse = (
                                rap * McountryFirm[country][firm].Mloan[ideBank][2]
                            )
                            reimboursements = reimboursements + reimbourse
                            losses = (
                                McountryFirm[country][firm].Mloan[ideBank][2]
                                * McountryFirm[country][firm].Mloan[ideBank][3]
                                + McountryFirm[country][firm].Mloan[ideBank][2]
                                - reimbourse
                            )
                            if countryBank != country:
                                self.DcountryForeignBankLosses[countryBank] = (
                                    self.DcountryForeignBankLosses[countryBank] + losses
                                )
                                self.DcountryForeignBankLosses[country] = (
                                    self.DcountryForeignBankLosses[country] - losses
                                )
                            if (
                                reimbourse
                                < McountryFirm[country][firm].Mloan[ideBank][2]
                                ...
                                McountryFirm[country][firm].repayingLoan(
                                    bankIde,
                                    reimbourse,
                                    reimbourse,
                                    McountryBank,
                                ...
                                McountryBank[countryBank][ideBank].Loan = (
                                    McountryBank[countryBank][ideBank].Loan - missLoan
                                )
                            if (
                                reimbourse
                                >= McountryFirm[country][firm].Mloan[ideBank][2]
                                ...
                                ideBank = bank
                                loanValue = McountryFirm[country][firm].Mloan[ideBank][
                                    2
                                ]
                                service = (
                                    reimbourse
                            ...
                            McountryBank[countryBank][ideBank].losses = (
                                McountryBank[countryBank][ideBank].losses + losses
                            )
    ...
    def exitBank(
        ...
        for country in McountryBank:
            ...
            for bank in LbankExit:
                ...
                serviceLoanCentralBank = McountryBank[country][bank].loanDiscount * (
                    1 + McountryCentralBank[country].rDiscount
                )
                McountryCentralBank[country].loanDiscount = (
                    McountryCentralBank[country].loanDiscount
                    - McountryBank[country][bank].loanDiscount
                )
                McountryCentralBank[country].Bonds = (
                    McountryCentralBank[country].Bonds + serviceLoanCentralBank
                )
                McountryCentralBank[country].interestLoanDiscount = (
                    McountryCentralBank[country].interestLoanDiscount
                    + McountryBank[country][bank].loanDiscount
                    * McountryCentralBank[country].rDiscount
                )
                McountryEtat[country].Bonds = (
                    McountryEtat[country].Bonds + serviceLoanCentralBank
                )
                ...
                self.DpastBondExit[country] = (
                    self.DpastBondExit[country]
                    + McountryBank[country][bank].pastBonds
                    + McountryBank[country][bank].pastBonds
                    * McountryEtat[country].rBonds
                )
                ...
                for agent in McountryBank[country][bank].Mdeposit:
                    ...
                    if ideAgent[0] == "C":
                        volumeCheck = McountryConsumer[countryAgent][ideAgent].Mdeposit[
                            bank
                        ][2]
                        if (
                            volume < volumeCheck - 0.0000001
                            or volume > volumeCheck + 0.0000001
                        ):
                            print("stop", stop)
                    ...
                    if ideAgent[0] == "F":
                        interest = 0
                        volumeCheck = McountryFirm[countryAgent][ideAgent].Mdeposit[
                            bank
                        ][2]
                        if (
                            volume < volumeCheck - 0.0000001
                    ...
                    McountryBank[country][bank].exitWithdrawal(
                        depositBack, McountryEtat, McountryCentralBank
                    )
                    ...
                    if newbankIde != countryAgent:
                        if (
                            ideAgent in McountryBank[countryAgent][newbankIde].Mdeposit
                        ) == True:
                            McountryBank[countryAgent][newbankIde].Mdeposit[ideAgent][
                                2
                            ] = (
                                McountryBank[countryAgent][newbankIde].Mdeposit[
                                    ideAgent
                                ][2]
                                + depositBack
                            )
                            McountryBank[countryAgent][newbankIde].Deposit = (
                                McountryBank[countryAgent][newbankIde].Deposit
                                + depositBack
                            )
                            McountryBank[countryAgent][newbankIde].Reserves = (
                                McountryBank[countryAgent][newbankIde].Reserves
                                + depositBack
                            )
                            McountryCentralBank[countryAgent].Reserves = (
                                McountryCentralBank[countryAgent].Reserves + depositBack
                            )
                            if ideAgent[0] == "C":
                                McountryConsumer[countryAgent][ideAgent].Mdeposit[
                                    newbankIde
                                ][2] = (
                                    McountryConsumer[countryAgent][ideAgent][
                                        2
                                    ].Mdeposit[newbankIde][2]
                                    + depositBack
                                )
                                McountryConsumer[countryAgent][
                                    ideAgent
                                ].depositInterest = (
                                    McountryConsumer[countryAgent][
                                        ideAgent
                            ...
                            if ideAgent[0] == "F":
                                McountryFirm[countryAgent][ideAgent].Mdeposit[
                                    newbankIde
                                ][2] = (
                                    McountryFirm[countryAgent][ideAgent].Mdeposit[
                                        newbankIde
                    ...
                    if newbankIde == countryAgent:
                        if (
                            ideAgent in McountryCentralBank[countryAgent].Mdeposit
                        ) == True:
                            McountryCentralBank[countryAgent].Mdeposit[ideAgent][2] = (
                                McountryCentralBank[countryAgent].Mdeposit[ideAgent][2]
                                + depositBack
                            )
                            McountryCentralBank[countryAgent].Deposit = (
                                McountryCentralBank[countryAgent].Deposit + depositBack
                            )
                            if ideAgent[0] == "C":
                                McountryConsumer[countryAgent][ideAgent].Mdeposit[
                                    newbankIde
                        ...
                        if (
                            ...
                            McountryCentralBank[countryAgent].Mdeposit[ideAgent] = [
                                ideAgent,
                                newbankIde,
                                depositBack,
                                interest,
                ...
                withdrawalDifference = (
                    sumDepositBack - McountryBank[country][bank].totalDeposit
                )
                McountryCentralBank[country].Reserves = (
                    McountryCentralBank[country].Reserves
                ...
                McountryEtat[country].Bonds = (
                    McountryEtat[country].Bonds - McountryBank[country][bank].Reserves
                )
                intDifference = (
                    sumInterestPayment
                ...
                McountryEtat[country].Salvatage = (
                    McountryEtat[country].Salvatage + intDifference
                )
