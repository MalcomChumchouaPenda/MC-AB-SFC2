...
class Lebalance:
      ...
      def innovatingAttempt(self,A,rDiscount):
             ...
             self.workForceNumberDesired=self.workForceNumberDesired+0.0*self.gamma*self.workForceNumberDesired
                 
      
      def innovatingEffective3(self, innovationExpenditure, phi,l,\
                             DglobalPhiNotTradable,avPhiGlobalTradable,tradable,avPriceGlobalTradable,McountryAvPriceNotTradable):
          if self.gamma>0.00000001:   
             ...
             if tradable=='no':            
                 if l>0 and McountryAvPriceNotTradable[self.country]*DglobalPhiNotTradable[self.country]>0:               
                   workerInnovationAvailableEffective=innovationExpenditure/float(McountryAvPriceNotTradable[self.country]*DglobalPhiNotTradable[self.country])
