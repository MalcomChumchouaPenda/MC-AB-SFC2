...
class policy:
    def __init__(
        self, timeStarting, policyKind, maxPublicDeficitAusterity, maxPublicDeficit
    ):
    ...
    def implementingPolicy(
        ...
        if time >= self.timeStarting:
            ...
            if self.policy == "austerity":
                for country in McountryEtat:
                    Lreturn = self.austerityPolicy(
                        McountryY[country],
                        McountryEtat[country].pastTaxCollected,
                        McountryEtat[country].interestExpenditure,
                        McountryEtat[country].addingSurplus,
                        McountryEtat[country].G,
                        McountryEtat[country].delta,
                        McountryEtat[country].taxRate,
                        DcountryAvWage[country],
                        DglobalPhi[country],
                        avWageOnPhi,
                        McountryEtat[country].initialG,
                        McountryAvPrice[country],
                        McountryEtat[country].Bonds,
                        avPhi,
                        avY,
                        McountryUnemployement[country],
                        avDebt,
                        McountryEtat[country].publicDeficit,
                        DcumulativeDTBC[country],
