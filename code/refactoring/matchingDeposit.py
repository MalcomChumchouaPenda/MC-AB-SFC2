...
class MatchingDeposit:
    ...
    def creatingAccount(
        self, McountryConsumer, McountryFirm, McountryBank, McountryCentralBank
    ):
            ...
            if len(McountryBank[country]) > 0 and self.DinCentralBank[country] == "no":
                for consumer in McountryConsumer[country]:
                    if len(McountryConsumer[country][consumer].Mdeposit) == 0:
                        ...
                        country in McountryConsumer[country][consumer].Mdeposit
                    ) == True:
                        random.shuffle(Lbank)
                        ideBank = Lbank[0]
                        ideConsumer = consumer
                        interestRate = McountryBank[country][ideBank].rDeposit
                        deposit = McountryConsumer[country][consumer].Mdeposit[country][
                            2
                        ]
                        ...
                        McountryCentralBank[country].Deposit = (
                            McountryCentralBank[country].Deposit - deposit
                        )
                        McountryBank[country][ideBank].Mdeposit[ideConsumer] = [
                            ideConsumer,
                            ideBank,
                ...
                for firm in McountryFirm[country]:
                    if len(McountryFirm[country][firm].Mdeposit) == 0:
                        ...
                        McountryBank[country][ideBank].Mdeposit[ideFirm] = [
                            ideFirm,
                            ideBank,
                            deposit,
                            interestRate,
                        ...
                        McountryFirm[country][ideFirm].Mdeposit[ideBank] = [
                            ideFirm,
                            ideBank,
                            deposit,
                            interestRate,
                        ...
                        if len(McountryFirm[country][firm].Mdeposit) == 1:
                            ...
                            for bank in self.LbankDeposit:
                                if bank != country:
                                    ideBank = bank
                                    ideFirm = firm
                                    interestRate = McountryBank[country][
                                        ideBank
                                    ].rDeposit
                                    deposit = McountryFirm[country][firm].Mdeposit[
                                        country
                                    ][2]
                                    del McountryCentralBank[country].Mdeposit[ideFirm]
                                    del McountryFirm[country][firm].Mdeposit[country]
            ...
            if len(McountryBank[country]) > 0 and self.DinCentralBank[country] == "yes":
                for consumer in McountryConsumer[country]:
                    if (
                        ...
                        if (
                            deposit
                            < McountryCentralBank[country].Mdeposit[ideConsumer][2]
                            - 0.00001
                            or deposit
                            > McountryCentralBank[country].Mdeposit[ideConsumer][2]
                            + 0.00001
                ...
                for firm in McountryFirm[country]:
                    if (country in McountryFirm[country][firm].Mdeposit) == True:
                        ...
                        if (
                            deposit
                            < McountryCentralBank[country].Mdeposit[ideFirm][2]
                            - 0.00001
                            or deposit
                            > McountryCentralBank[country].Mdeposit[ideFirm][2]
                            + 0.00001
            ...
            if len(McountryBank[country]) == 0:
                ...
                for consumer in McountryConsumer[country]:
                    if len(McountryConsumer[country][consumer].Mdeposit) == 0:
                        ...
                        deposit = 0
                        McountryCentralBank[country].Mdeposit[ideConsumer] = [
                            ideConsumer,
                            ideBank,
                            deposit,
                            interestRate,
                ...
                for firm in McountryFirm[country]:
                    if len(McountryFirm[country][firm].Mdeposit) == 0:
                        ...
                        interestRate = McountryCentralBank[country].rDeposit
                        deposit = McountryFirm[country][firm].A
                        McountryCentralBank[country].Mdeposit[ideFirm] = [
                            ideFirm,
                            ideBank,
                            deposit,
                            interestRate,
    ...
    def allocatingConsumerDeposit(self, McountryConsumer, McountryBank):
        ...
        for country in McountryBank:
            if len(McountryBank[country]) > 1 and self.DinCentralBank[country] == "no":
                ...
                if (
                    self.createdReserves > self.delatedReserves + 0.00001
                    or self.createdReserves < self.delatedReserves - 0.00001
                ):
                    print("stop", stop)
            if len(McountryBank[country]) > 0:
    ...
    def extractingDeposit(self, McountryConsumer, McountryBank, country):
        ...
        for bank in McountryBank[country]:
            depositDemand = [
                McountryBank[country][bank].ide,
                McountryBank[country][bank].rDeposit,
            ]
