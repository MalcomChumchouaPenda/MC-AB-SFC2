...
class Aggregator:
    def __init__(
        self, Lcountry, name, folder, timeCollectingStart, LtimeCollecting, printAgent
    ):
    ...
    def unemployement(self, McountryConsumer):
        ...
        for country in McountryConsumer:
            ...
            self.McountryUnemployement[country] = (totLabor - laborEmployed) / float(
                totLabor
            )
    ...
    def income(
            ...
            for consumer in McountryConsumer[country]:
                for good in McountryConsumer[country][consumer].LConsumptionEff:
                    if good[3] != McountryConsumer[country][consumer].country:
                        expCountry = good[3]
                        DcountryExport[expCountry] = (
                            DcountryExport[expCountry] + good[0] * good[1]
                        )
                        DcountryImport[country] = (
                            DcountryImport[country] + good[0] * good[1]
                        )
        for country in McountryConsumer:
            LproductProduced = []
            ...
            for consumer in McountryConsumer[country]:
                ...
                disposableIncomeC = (
                    disposableIncomeC
                    + McountryConsumer[country][consumer].disposableIncome
                )
                ConsumptionC = (
                    ConsumptionC + McountryConsumer[country][consumer].Consumption
                )
                ExpenditureC = (
                    ExpenditureC + McountryConsumer[country][consumer].Expenditure
                )
                ExpenditureCTradable = (
                    ExpenditureCTradable
                    + McountryConsumer[country][consumer].ExpenditureTradable
                )
                ExpenditureCNotTradable = (
                    ExpenditureCNotTradable
                    + McountryConsumer[country][consumer].ExpenditureNotTradable
                )
                quantityConsumedC = (
                    quantityConsumedC
                    + McountryConsumer[country][consumer].quantityConsumed
                )
                quantityConsumedCTradable = (
                    quantityConsumedCTradable
                    + McountryConsumer[country][consumer].quantityConsumedTradable
                )
                quantityConsumedCNotTradable = (
                    quantityConsumedCNotTradable
                ...
                DepositingC = (
                    DepositingC + McountryConsumer[country][consumer].Depositing
                )
                ...
                wc = (
                    wc
                    + McountryConsumer[country][consumer].wOffered
                    * McountryConsumer[country][consumer].l
                )
                SavingC = (
                    SavingC
                    + McountryConsumer[country][consumer].savingIncome
                    + McountryConsumer[country][consumer].Consumption
                    - McountryConsumer[country][consumer].Expenditure
                )
                liqPref = liqPref + McountryConsumer[country][consumer].liqPref
                PastInvesting = (
                    PastInvesting + McountryConsumer[country][consumer].PastInvesting
                )
                PastDepositing = (
                    PastDepositing + McountryConsumer[country][consumer].PastDepositing
                )
                PastA = PastA + McountryConsumer[country][consumer].PastA
                depositAllocated = (
                    depositAllocated
                    + McountryConsumer[country][consumer].depositAllocated
                )
            avliqPref = liqPref / float(len(McountryConsumer[country]))
            print()
            print(
                "country ", country, "unemployment ", (totLabor - LC) / float(totLabor)
            )
            avWage = 1.0
            if LC > 0:
                avWage = wc / float(LC)
            ...
            for firm in McountryFirm[country]:
                ...
                nWorkerDesired = (
                    nWorkerDesired + McountryFirm[country][firm].nWorkerDesired
                )
                laborExpenditure = (
                    laborExpenditure + McountryFirm[country][firm].laborExpenditure
                )
                sumRatioGamma = sumRatioGamma + McountryFirm[country][firm].ratioGamma
                changeInventoryValue = (
                    changeInventoryValue
                    + McountryFirm[country][firm].changeInventoryValue
                )
                inventory = inventory + McountryFirm[country][firm].inventory
                sumInterestRate = (
                    sumInterestRate
                    + McountryFirm[country][firm].loanReceived
                    * McountryFirm[country][firm].interestRate
                )
                productionQuantity = (
                    productionQuantity + McountryFirm[country][firm].productionEffective
                )
                inventoryValue = (
                    inventoryValue + McountryFirm[country][firm].inventoryValue
                )
                innovationExpenditure = (
                    innovationExpenditure
                    + McountryFirm[country][firm].innovationExpenditure
                )
                if McountryFirm[country][firm].tradable == "yes":
                    ...
                    productionQuantityTradableSold = (
                        productionQuantityTradableSold + xSold
                    )
                    wageBillTradable = (
                        wageBillTradable
                        + McountryFirm[country][firm].w * McountryFirm[country][firm].l
                    )
                    laborTradable = laborTradable + McountryFirm[country][firm].l
                    sumPhiGlobalTradable = (
                        sumPhiGlobalTradable
                        + xTradable * McountryFirm[country][firm].phi
                    )
                    sumProductionGlobalTradable = (
                        sumProductionGlobalTradable + xTradable
                    )
                    sumProductionSoldGlobalTradable = (
                        sumProductionSoldGlobalTradable + p * xSold
                    )
                    sumProductionQuantitySoldGlobalTradable = (
                        sumProductionQuantitySoldGlobalTradable + xSold
                    )
                pastFirmA = pastFirmA + McountryFirm[country][firm].PreviousA
                profitRate = profitRate + McountryFirm[country][firm].profitRate
                profitRateperA = (
                    profitRateperA
                    + McountryFirm[country][firm].profitRate
                    * McountryFirm[country][firm].PreviousA
                )
            ...
            sumProductionQuantitySoldGlobal = (
                sumProductionQuantitySoldGlobal + productionQuantitySold
            )
            ...
            if productionQuantityTradableSold > 0:
                avPCTradable = productionCTradableSold / float(
                    productionQuantityTradableSold
                )
            if quantityConsumedCNotTradable > 0:
                avPCNotTradable = ExpenditureCNotTradable / float(
                    quantityConsumedCNotTradable
                )
            inflation = 0
            if pastAvPC > 0:
            ...
            if self.McountryY[country] > 0:
                print(
                    ...
                    country,
                    "Credit/Y ",
                    loanReceivedC / self.McountryY[country],
                )
            ...
            if DglobalPhiTradable[country] > 0:
                print(
                    ...
                    country,
                    "w/phi Tradable",
                    avWageTradable / float(DglobalPhiTradable[country]),
                )
            pastProductionC = self.McountryY[country]

            self.McountryGrowth[country] = 0
            if pastProductionC > 0:
                self.McountryGrowth[country] = (productionC - pastProductionC) / float(
                    pastProductionC
                )
            if productionC > 0:
                print(
                    ...
                    country,
                    "debt/Y ",
                    McountryEtat[country].Bonds / float(productionC),
                )
            if productionC > 0:
                print(
                    "country ",
                    country,
                    "G/Y",
                    McountryEtat[country].realG / float(productionC),
                )
            if self.McountryY[country] > 0:
                print(
                    "country ",
                    country,
                    "deficit/Y ",
                    McountryEtat[country].publicDeficit / self.McountryY[country],
                )
                print(
                    "country ",
                    country,
                    "(X+M)/Y ",
                    (DcountryExport[country] + DcountryImport[country])
                    / self.McountryY[country],
                )
            ...
            MK = (
                creditCapitalInflow[country]
                - creditCapitalOutflow[country]
                + creditBondInflow[country]
                - creditBondOutflow[country]
            )
            BdP = (
                creditCapitalInflow[country]
                - creditCapitalOutflow[country]
            ...
            self.DcountryFailureProbability[country] = 0
            if nfirmC + nbankC > 0:
                self.DcountryFailureProbability[country] = (
                    DcountryBankExit[country] + DcountryFirmExit[country]
                ) / float(nfirmC + nbankC)
            ...
            self.DcountryCollectData[country] = [
                ...
                DglobalPhi[country],
                nbankC,
                McountryEtat[country].publicDeficit,
                McountryEtat[country].Bonds,
                avPC,
                bankLoan,
                bankBonds,
                McountryCentralBank[country].Bonds,
                self.firmA,
                DcountryFirmEnter[country],
                DcountryFirmExit[country],
                DcountryBankEnter[country],
                DcountryBankExit[country],
                AbankC,
                nfirmCTradable,
                nfirmCNotTradable,
                AfirmCTradable,
                DglobalPhiTradable[country],
                DglobalPhiNotTradable[country],
                avPCTradable,
                avPCNotTradable,
                SavingC,
                nCreditLink,
                averageFirmProfit,
                McountryEtat[country].adjust,
                productionCSold + changeInventoryValue,
                McountryEtat[country].Salvatage,
                bankLosses,
        ...
        for country in McountryConsumer:
            if self.McountryY[country] > 0:
                self.DcumulativeTBC[country] = (
                    self.DcumulativeTBC[country] + self.DcountryTradeBalance[country]
                )
                self.DcumulativeDTBC[country] = self.DcumulativeTBC[country] / float(
                    self.McountryY[country]
                )
        self.avPriceGlobal = 0
        if sumProductionQuantitySoldGlobal > 0:
            self.avPriceGlobal = sumProductionSoldGlobal / float(
                sumProductionQuantitySoldGlobal
            )
        self.avPriceGlobalTradable = 0
        if sumProductionQuantitySoldGlobalTradable > 0:
            self.avPriceGlobalTradable = sumProductionSoldGlobalTradable / float(
                sumProductionQuantitySoldGlobalTradable
            )
        self.avPhiGlobal = 0
        ...
        if sumProductionGlobalTradable > 0:
            self.avPhiGlobalTradable = sumPhiGlobalTradable / float(
                sumProductionGlobalTradable
            )
        if R < 0:
            print("stop", stop)
    ...
    def checkCA(
        ...
        for country in McountryConsumer:
            ...
            self.DdismissedA[country] = 0
            self.DpastPotentialExitConsumer[country] = self.DpotentialExitConsumer[
                country
            ]
            self.DpotentialExitConsumer[country] = 0
            ...
            for firm in McountryFirm[country]:
                ...
                pastFirmSaving = (
                    pastFirmSaving + McountryFirm[country][firm].pastFirmSaving
                )
            ...
            for firm in DcountryFirmGone[country]:
                ...
                pastFirmProfit = (
                    pastFirmProfit + DcountryFirmGone[country][firm].pastProfit
                )
                pastFirmSaving = (
                    pastFirmSaving + DcountryFirmGone[country][firm].pastFirmSaving
                )
                profitRate = profitRate + DcountryFirmGone[country][firm].profitRate
                profitRateA = (
                    profitRateA
                    + DcountryFirmGone[country][firm].profitRate
                    * DcountryFirmGone[country][firm].PreviousA
                )
                agentA = agentA + DcountryFirmGone[country][firm].PreviousA
                if (
                    DcountryFirmGone[country][firm].profit
                    + DcountryFirmGone[country][firm].PreviousA
                    > 0
                ):
                    self.DdismissedA[country] = self.DdismissedA[country] + (
                        DcountryFirmGone[country][firm].profit
                        + DcountryFirmGone[country][firm].PreviousA
                    )
            for bank in McountryBank[country]:
                ...
                pastBankSaving = (
                    pastBankSaving + McountryBank[country][bank].pastBankSaving
                )
                self.DpotentialExitConsumer[country] = (
                    self.DpotentialExitConsumer[country]
                    + McountryBank[country][bank].potentialExitConsumer
                )
                self.DbondsInterest[country] = (
                    self.DbondsInterest[country]
                    + McountryBank[country][bank].bondsInterest
                )
                self.DpotentialExitCB[country] = (
                    self.DpotentialExitCB[country]
                    + McountryBank[country][bank].potentialExitCB
                )
                self.Dlosses[country] = (
                    self.Dlosses[country] + McountryBank[country][bank].losses
                )
                profitRate = profitRate + McountryBank[country][bank].profitRate
                profitRateA = (
                    profitRateA
                    + McountryBank[country][bank].profitRate
                    * McountryBank[country][bank].PreviousA
                )
            ...
            for bank in DcountryBankGone[country]:
                ...
                pastBankProfit = (
                    pastBankProfit + DcountryBankGone[country][bank].pastProfit
                )
                pastBankSaving = (
                    pastBankSaving + DcountryBankGone[country][bank].pastBankSaving
                )
                self.DpotentialExitConsumer[country] = (
                    self.DpotentialExitConsumer[country]
                    + DcountryBankGone[country][bank].potentialExitConsumer
                )
                self.DbondsInterest[country] = (
                    self.DbondsInterest[country]
                    + DcountryBankGone[country][bank].bondsInterest
                )
                self.DpotentialExitCB[country] = (
                    self.DpotentialExitCB[country]
                    + DcountryBankGone[country][bank].potentialExitCB
                )
                self.DserviceFirm[country] = (
                    self.DserviceFirm[country]
                    + DcountryBankGone[country][bank].pastServiceFirm
                )
                self.Dlosses[country] = (
                    self.Dlosses[country] + DcountryBankGone[country][bank].losses
                )
                self.Dloss[country] = (
                    self.Dloss[country] + DcountryBankGone[country][bank].loss
                )
                profitRate = profitRate + DcountryBankGone[country][bank].profitRate
                profitRateA = (
                    profitRateA
                    + DcountryBankGone[country][bank].profitRate
                    * +DcountryBankGone[country][bank].PreviousA
                )
                agentA = agentA + DcountryBankGone[country][bank].PreviousA
                if (
                    DcountryBankGone[country][bank].profit
                    + DcountryBankGone[country][bank].PreviousA
                    > 0
                ):
                    self.DdismissedA[country] = self.DdismissedA[country] + (
            ...
            PrivateSaving = (
                ...
                + firmProfit
                + bankProfit
                - (pastProfit - pastFirmSaving - pastBankSaving)
                - self.DpastDismissedA[country]
                + self.DpotentialExitConsumer[country]
                - self.DpastPotentialExitConsumer[country]
                - self.DbondsInterest[country]
                + self.DpastBondsInterest[country]
                + self.DpotentialExitCB[country]
                - self.DpastPotentialExitCB[country]
                + self.Dlosses[country]
                + self.DpastLoss[country]
            )
            PublicSaving = -1 * McountryEtat[country].publicDeficit
            CA = (
                self.DTBC[country]
                + McountryCentralBank[country].diffInflowOutflow
                + DcountryForeignBankLosses[country]
            ...
            self.DcountryCollectData[country].append(
                McountryCentralBank[country].diffInflowOutflow
                + DcountryForeignBankLosses[country]
            )
            self.DcountryCollectData[country].append(
            ...
            if self.McountryY[country] > 0:
                if (
                    CA < PrivateSaving + PublicSaving - 0.001
                    or CA > PrivateSaving + PublicSaving + 0.001
                    or country == "0"
                    or country == "1"
                ):
                    print("stop", stop)
    ...
    def checkNetWorth(
        ...
        for country in McountryConsumer:
            ...
            for consumer in McountryConsumer[country]:
                nW = (
                    McountryConsumer[country][consumer].Deposit
                    + McountryConsumer[country][consumer].A
                )
            ...
            for firm in McountryFirm[country]:
                ...
                assetsFirm = (
                    assetsFirm
                    + McountryFirm[country][firm].Deposit
                    + McountryFirm[country][firm].A
                )
                netWorthFirm = netWorthFirm + nW
            for bank in McountryBank[country]:
                netWorthBank = (
                    netWorthBank
                    + McountryBank[country][bank].Reserves
                    + McountryBank[country][bank].Bonds
                    + McountryBank[country][bank].Loan
                    - McountryBank[country][bank].Deposit
                    - McountryBank[country][bank].A
                )
                assetsBank = (
                    assetsBank
                    + McountryBank[country][bank].Reserves
            ...
            netWorthCentralBank = (
                McountryCentralBank[country].Bonds
                + McountryCentralBank[country].loanDiscount
                - McountryCentralBank[country].DepositEtatCentralBank
                - McountryCentralBank[country].Deposit
                - McountryCentralBank[country].Reserves
            )
            netWorthEtat = (
                McountryEtat[country].LiquidityEtat - McountryEtat[country].Bonds
            )
            netWorth = (
                netWorthConsumer
                + netWorthBank
            ...
            if (
                netWorth / float(netWorthConsumer) > 0.0001
                or netWorth / float(netWorthConsumer) < -0.0001
                or netWorthFirm / float(assetsFirm) > 0.0001
                or netWorthFirm / float(assetsFirm) < -0.0001
                or netWorthBank / float(assetsBank) > 0.0001
                or netWorthBank / float(assetsBank) < -0.0001
            ):
                print("stop", stop)
