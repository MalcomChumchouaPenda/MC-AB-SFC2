...
class Aggregator:
      ...
      def income(self,McountryConsumer,t,run,McountryFirm,McountryEtat,McountryBank,McountryCentralBank,DglobalPhi,DcountryFirmEnter,\
                 DcountryFirmExit,DcountryBankEnter,DcountryBankExit,DglobalPhiTradable,DglobalPhiNotTradable,\
          ...
          for country in McountryConsumer:
              ...
              for firm in  McountryFirm[country]:
                  ...
                  nWorkerDesired=nWorkerDesired+McountryFirm[country][firm].nWorkerDesired 
              ...
              if productionC>0:
                 print( 'country ', country,  'debt/Y ', McountryEtat[country].Bonds/float(productionC))
              if productionC>0: 
                 print( 'country ', country,   'G/Y', McountryEtat[country].realG/float(productionC))
              if  self.McountryY[country]>0:
              ...
              self.DcountryCollectData[country]=[run,t,country,productionC,DcountryExport[country],DcountryImport[country],nfirmC,\
                                   ...
                                   productionCSold+changeInventoryValue,McountryEtat[country].Salvatage,bankLosses,McountryEtat[country].taxRate,\
                                   ...
                                   McountryCentralBank[country].rDiscount,loanDemandedC,averageInterestRate,inventoryValue,productionQuantity,\
                                   DcountryEnterValue[country],innovationExpenditure]
          totalTB=0
          totalY=0      
          for country in McountryConsumer:
              TBC=DcountryExport[country]-DcountryImport[country] 
      ...
      def WriteInitial(self):
          ...
          L=['run','time','country','Yprod','Export','Import','nFirm', 'avWage','nOccupied',\
             ...
             'bankLoan','bankBonds','cbBonds','netWorthFirm','enteringFirm','exitingFirm','enteringBank',\
             ...
             'EnterValue','innovationExpenditure',\
             'CA','PrivateSaving',\
