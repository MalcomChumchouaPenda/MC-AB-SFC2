          ...
          for country in McountryFirm:
              ...
              for firm in  McountryFirm[country]:
                  ...
                  if McountryFirm[country][firm].closing=='no': 
                     ...
                     nWorkerDesired=min(McountryFirm[country][firm].workForceNumberDesired,nWorkerPossible) 
                     ...
                     LdemandLabor.append([McountryFirm[country][firm].ide,x,0,\
                                          ...
                                          0,'firm',country,0,p,nWorkerDesired])
              ...
              for consumer in McountryConsumer[country]:   
                  ...
                  LfirmConsumer=[]
                  LsupplyLabor.append([wageDemanded,McountryConsumer[country][consumer].w,McountryConsumer[country][consumer].ide,posConsumer,0,0,LfirmConsumer])
              ...
              for supply in LsupplyLabor:
                  ...
                  for job in LchoiceJob: 
                      ...
                      if LdemandLabor[posDemand][8]=='firm':       
                         ...
                         LwageOffered.append([wOffered,posDemand,nWorkerDesired,money]) 
                  ...
                  for wageOffer in LwageOffered:
                      ...
                      if nWorkerDesired>0.001 and LdemandLabor[posDemand][6]>=0.001\
                         ...
                         if labor>0.001:
                            ...
                            if labor>=0.001:
                               ...
                               McountryFirm[countryFirm][firmide].Lemployed.append([ideWorker,labor])
                         ...
                         if LdemandLabor[posDemand][1]<=0.001 or LdemandLabor[posDemand][6]<=0.001:
                            if LdemandLabor[posDemand][1]<-0.001:  
                               print('stop', stop)
                         if LdemandLabor[posDemand][6]<=0.001 or nWorkerDesired<=0.001:
                            self.McountryDemandLabor[country].append(LdemandLabor[posDemand])
      ...
      def laborDisMatch(self,McountryFirm,McountryConsumer,McountryEtat,McountryBank,McountryCentralBank):
          for country in McountryFirm:
              ...
              for demand in self.McountryDemandLabor[country]:
                     posFirm=demand[5]
                     firmide=demand[0]                
                     McountryFirm[country][firmide].l=McountryFirm[country][firmide].l+demand[2]
                     ...
                     if McountryFirm[country][firmide].l>0:
                        expenditureTotWorker=McountryFirm[country][firmide].workForceInnovationExpenditureDesired*\
                           (McountryFirm[country][firmide].l/float(McountryFirm[country][firmide].nWorkerDesired)) 
                        McountryFirm[country][firmide].innovationExpenditure=min(resources,McountryFirm[country][firmide].workForceInnovationExpenditureDesired) 
                        McountryFirm[country][firmide].innovationExpenditurePerWorker=\
                              McountryFirm[country][firmide].innovationExpenditure/float(McountryFirm[country][firmide].l) 
                     ...
                     for worker in  McountryFirm[country][firmide].Lemployed:
                         ...
                         McountryConsumer[country][ideworker].innovationIncome=\
                          McountryConsumer[country][ideworker].innovationIncome+McountryFirm[country][firmide].innovationExpenditurePerWorker*laborworker 
              ...
              for supply in self.McountrySupplyLabor[country]:
                  ...
                  if McountryConsumer[country][ideConsumer].l>0.0:
                     ...
                     McountryConsumer[country][ideConsumer].averagewOffered=\
                                  sum(McountryConsumer[country][ideConsumer].LwOffered)/float(len(McountryConsumer[country][ideConsumer].LwOffered))
                  if McountryConsumer[country][ideConsumer].l<=0.0:
                  ...
                  McountryConsumer[country][ideConsumer].receiving(McountryConsumer[country][ideConsumer].laborIncome,McountryBank,McountryCentralBank)
