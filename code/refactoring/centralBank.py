...
class CentralBank:
    ...
    def checkNetWorth(self):
        Liabilities = (
            self.Reserves
            + self.DepositEtatCentralBank
            + self.Deposit
            + self.profit
            + self.LoanCentralBankUnion
            - self.DepositUnion
            + self.CreditTaxCentralBankUnion
        )
        Assets = (
            self.Bonds
            + self.loanDiscount
            + self.LiquidityCentralBank
            + self.DepositCentralBankUnion
            + self.profit
            + self.DebtTaxCentralBankUnion
        )
        if (
    ...
    def balancing(
        self, McountryConsumer, McountryFirm, McountryEtat, CentralBankUnion, DTBC
    ):
        self.profit = self.interestLoanDiscount - self.depositInterest
        McountryEtat[self.country].Bonds = (
            McountryEtat[self.country].Bonds - self.profit
        )
        ...
        self.diffBondRepeymentInflowOutflow = (
            self.bondRepeymentInflow - self.bondRepeymentOutflow
        )
        ...
        self.LoanCentralBankUnion = (
            self.LoanCentralBankUnion + changingLoanCentralBankUnion
        )
        self.DepositCentralBankUnion = (
            self.DepositCentralBankUnion + changingDepositCentralBankUnion
        )
        CentralBankUnion.LoanCentralBankUnion = (
            CentralBankUnion.LoanCentralBankUnion + changingLoanCentralBankUnion
        )
        CentralBankUnion.DepositCentralBankUnion = (
            CentralBankUnion.DepositCentralBankUnion + changingDepositCentralBankUnion
        )
        changingCreditTaxCentralBankUnion = 0
        changingDebtTaxCentralBankUnion = 0
        self.CreditTaxCentralBankUnion = (
            self.CreditTaxCentralBankUnion + changingCreditTaxCentralBankUnion
        )
        self.DebtTaxCentralBankUnion = (
            self.DebtTaxCentralBankUnion + changingDebtTaxCentralBankUnion
        )
        CentralBankUnion.CreditTaxCentralBankUnion = (
            CentralBankUnion.CreditTaxCentralBankUnion
            + changingCreditTaxCentralBankUnion
        )
        CentralBankUnion.DebtTaxCentralBankUnion = (
            CentralBankUnion.DebtTaxCentralBankUnion + changingDebtTaxCentralBankUnion
        )
        self.interestLoanDiscount = 0
        self.checkNetWorth()
