...
class Etat:
      ...
      def governmentPlannedExpenditure(self,McountryConsumer,McountryFirm,McountryCentralBank,\
          ...
          if self.startingTime<self.endTransitionTime:
             self.realG=McountryAvPrice[self.country]*DglobalPhi[self.country]*self.initialG
             self.G=McountryAvPrice[self.country]*DglobalPhi[self.country]*self.initialG    
          if self.startingTime>=self.endTransitionTime: 
      ...
      def redistributionConsumer(self,McountryConsumer,McountryBank,McountryCentralBank,McountryAvPrice,t):
             ...
             if self.LiquidityEtat<-0.000001 or self.LiquidityEtat+self.expenditure<self.realG-0.00001:
                print('stop', stop)      
