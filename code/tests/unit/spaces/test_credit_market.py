...
from mc_ab_sfc.spaces.credit_market import CreditMarket
...
def test_add_borrower_creates_borrower_role(market, monkeypatch):
    ...
    monkeypatch.setattr("mc_ab_sfc.spaces.credit_market.BorrowerRole", FakeRole)
...
def test_add_lender_creates_lender(market, monkeypatch):
    ...
    bank = Mock()
    market.add_role = Mock()
    monkeypatch.setattr("mc_ab_sfc.spaces.credit_market.LenderRole", FakeRole)
