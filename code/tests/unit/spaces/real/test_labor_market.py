...
from mc_ab_sfc2.spaces.real import LaborMarket
...
def test_add_worker_creates_worker_role(market, monkeypatch):
    ...
    monkeypatch.setattr("mc_ab_sfc2.spaces.real.WorkerRole", FakeRole)
...
def test_add_employer_creates_employer_role(market, monkeypatch):
    ...
    firm = Mock()
    market.add_role = Mock()
    monkeypatch.setattr("mc_ab_sfc2.spaces.real.EmployerRole", FakeRole)
