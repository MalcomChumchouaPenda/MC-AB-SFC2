...
from mc_ab_sfc2.spaces.goods_market import GoodsMarket
...
def test_add_consumer_creates_tradable_consumer_role(market, monkeypatch):
    ...
    monkeypatch.setattr("mc_ab_sfc2.spaces.goods_market.ConsumerRole", FakeRole)
...
def test_add_supplier_creates_producer_role(market, monkeypatch):
    ...
    firm = Mock()
    market.add_role = Mock()
    monkeypatch.setattr("mc_ab_sfc2.spaces.goods_market.ProducerRole", FakeRole)
